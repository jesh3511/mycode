...
def main():
    ...
    with open("output.py", "w") as outfile:
        ...
        print("{'ext' : ", E/40, "},", sep="", file=outfile)
        print("{'agr' : ", A/40, "},", sep="", file=outfile)
        print("{'con' : ", C/40, "},", sep="", file=outfile)
        print("{'neu' : ", N/40, "},", sep="", file=outfile)
        print("{'ope' : ", O/40, "},", sep="", file=outfile)
        print("]", file=outfile)
